...
digital oversampling I 2

[LDBP parameters]
step size method = linear
split step method = asymmetric
less steps than spans = yes
total steps = 4
cd filter method = LS-CO
cd filter bandwidth = 0.6
cd filter max out-of-band gain = 0.8
optimize cd filters = no
optimize Kerr parameters = yes
tied Kerr parameters = yes
nl filter length = 41
...
number of parallel processo%s = 10
