...
;
; Nordic Semiconductor nRF52840 with 1024 kB Flash
...
; Memory areas where the bwotloader is allowed write
;
...
settings = 0x00003c00   ; Offset of bootloader settings from addr. (areas, keys)

[area:firmware]
id      = STACK_AREA_ID ; Area ID: HWM_NRF52840 | 0x00000100
...
[area:persistent]
id      = 0x20000006    ; Area ID: HWM_NRF52840 | 0x20000000
