...
ruleset=🎯 全球直连,https://raw.githubusercontent.com/runishiwo/rule/main/Direct.list
ruleset=🚀 节点选择,https://raw.githubusercontent.com/runishiwo/rule/main/ProxyLite.list
ruleset=🤖 AI,https://raw.githubusercontent.com/Coldvvater/Mononoke/master/Clash/Rules/AI.list
...
;策略组定义
custom_proxy_group=🚀 节点选择`select`[]♻️ 自动选择`[]🔯 香港故转`[]🔯 日本故转`[]🔯 欧洲故转`[]🇭🇰 香港节点`[]🇯🇵 日本节点`[]🇸🇬 欧洲节点`[]🇺🇲 美国节点`[]🛩️ 高速节点`[]🐸 手动切换`[]DIRECT
custom_proxy_group=📹 YouTube`select`[]🚀 节点选择`[]🔯 香港故转`[]🔯 日本故转`[]🔯 欧洲故转`[]🇭🇰 香港节点`[]🇯🇵 日本节点`[]🇸🇬 欧洲节点`[]🇺🇲 美国节点`[]🛩️ 高速节点`[]🐸 手动切换`[]DIRECT
custom_proxy_group=🤖 AI`select`[]🚀 节点选择`[]🔯 日本故转`[]🇺🇲 美国节点`[]🇯🇵 日本节点`[]🇸🇬 欧洲节点`[]🇭🇰 香港节点`[]🐸 手动切换
custom_proxy_group=💧 Copilot`select`[]🚀 节点选择`[]🔯 日本故转`[]🔯 欧洲故转`[]🇯🇵 日本节点`[]🇺🇲 美国节点`[]🇭🇰 香港节点`[]🇸🇬 欧洲节点`[]🐸 手动切换
custom_proxy_group=🐬 OneDrive`select`[]🚀 节点选择`[]🔯 日本故转`[]🔯 香港故转`[]🔯 欧洲故转`[]🇯🇵 日本节点`[]🇭🇰 香港节点`[]🇸🇬 欧洲节点`[]🇺🇲 美国节点`[]🛩️ 高速节点`[]🐸 手动切换`[]DIRECT
custom_proxy_group=🪟 Microsoft`select`[]🚀 节点选择`[]🔯 日本故转`[]🔯 香港故转`[]🔯 欧洲故转`[]🇯🇵 日本节点`[]🇭🇰 香港节点`[]🇸🇬 欧洲节点`[]🇺🇲 美国节点`[]🛩️ 高速节点`[]🐸 手动切换`[]DIRECT
custom_proxy_group=🍀 Google`select`[]🚀 节点选择`[]🔯 香港故转`[]🔯 日本故转`[]🔯 欧洲故转`[]🇭🇰 香港节点`[]🇯🇵 日本节点`[]🇸🇬 欧洲节点`[]🇺🇲 美国节点`[]🛩️ 高速节点`[]🐸 手动切换`[]DIRECT
custom_proxy_group=👨🏿‍💻 GitHub`select`[]🚀 节点选择`[]🔯 香港故转`[]🔯 日本故转`[]🔯 欧洲故转`[]🇭🇰 香港节点`[]🇯🇵 日本节点`[]🇸🇬 欧洲节点`[]🇺🇲 美国节点`[]🛩️ 高速节点`[]🐸 手动切换`[]DIRECT
custom_proxy_group=🍎 Apple`select`[]DIRECT`[]🇭🇰 香港节点`[]🇯🇵 日本节点`[]🇸🇬 欧洲节点`[]🇺🇲 美国节点`[]🐸 手动切换`[]🚀 节点选择
custom_proxy_group=🎵 TikTok`select`[]🚀 节点选择`[]🔯 日本故转`[]🔯 欧洲故转`[]🇯🇵 日本节点`[]🇸🇬 欧洲节点`[]🛩️ 高速节点`[]🐸 手动切换
custom_proxy_group=📲 Telegram`select`[]🚀 节点选择`[]🔯 香港故转`[]🔯 日本故转`[]🔯 欧洲故转`[]🇭🇰 香港节点`[]🇯🇵 日本节点`[]🇸🇬 欧洲节点`[]🐸 手动切换
custom_proxy_group=📢 FCM`select`[]🚀 节点选择`[]🔯 香港故转`[]🔯 日本故转`[]🔯 欧洲故转`[]🇭🇰 香港节点`[]🇯🇵 日本节点`[]🇸🇬 欧洲节点`[]🐸 手动切换
;custom_proxy_group=🎮 游戏平台`select`[]🚀 节点选择`[]🔯 香港故转`[]🔯 日本故转`[]🔯 欧洲故转`[]🇭🇰 香港节点`[]🇯🇵 日本节点`[]🇸🇬 欧洲节点`[]🛩️ 高速节点`[]🐸 手动切换`[]DIRECT
custom_proxy_group=🌍 国外媒体`select`[]🚀 节点选择`[]🔯 香港故转`[]🔯 日本故转`[]🔯 欧洲故转`[]🇭🇰 香港节点`[]🇯🇵 日本节点`[]🇸🇬 欧洲节点`[]🛩️ 高速节点`[]🐸 手动切换
custom_proxy_group=🎞️ 国内媒体`select`[]DIRECT`[]🚀 节点选择`[]🐸 手动切换
custom_proxy_group=🎯 全球直连`select`[]DIRECT`[]🚀 节点选择`[]🐸 手动切换
custom_proxy_group=🐟 漏网之鱼`select`[]🚀 节点选择`[]DIRECT`[]🇭🇰 香港节点`[]🇯🇵 日本节点`[]🇸🇬 欧洲节点`[]🐸 手动切换

custom_proxy_group=🐸 手动切换`select`.*
custom_proxy_group=🛩️ 高速节点`select`(?=.*(香港|HK|Hong Kong|🇭🇰|HongKong|日本|韩国|东京|大阪|泉日|埼玉|沪日|深日|JP|Japan))^((?!(深港|家宽|游戏|剩余|流量|0.5|0.5倍|0.5x|2.0|2倍|2x|3.0|3倍|3x|4.0|4倍|4x|5.0|5倍|5x)).)*$
...
custom_proxy_group=🇸🇬 欧洲节点`select`(?=.*(欧洲|坡|狮城|SG|Singapore))^((?!(家宽|游戏|剩余|流量|2O0|2倍|2x|3.0|3倍|3x|4.0|4倍|4x)).)*$
...
custom_proxy_group=🔯 欧洲故转`fallback`(?=.*(欧洲|坡|狮城|SG|Singapore))^((?!(家宽|游戏|剩余|流量|0.5|0.5倍|0.5x|2.0|2倍|2x|3.0|3倍|3x|4.0|4倍|4x|5.0|5倍|5x)).)*$`http://www.gstatic.com/generate_204`300,,50
