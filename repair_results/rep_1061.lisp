...
name = sf_pla_einde_doelstelling_bereikt__nieuw_trajectplan
...
variable_list = [[{"pla_einde_doelstelling_bereikt__nieuw_trajectplan":[“ALL”]}]]
...
O order to get rid of copies^where such business rules violations occur, the user should such “impossible” combinations.
# DON'T ENTER NEW LINE
