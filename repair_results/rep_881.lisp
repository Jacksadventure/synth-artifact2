...
SYSTEM = Au-111 #The 'title' string for your job name   
#FILENAME = /path/to/your/DOSCAR #Path to the DOSCAR you want to analyze 
FILENAME = DOSCAR
FILETYPE = vasp #The format of DOSCAR: vasp or lobster. 
...
#-----------------------------------------------------------------------------#
ATOM_OBJECT = Au, d, 1-45


#DBC-Analysis Chunk
ANALDBC = True #Whether to calculate d-band center 
DBCORBITAL = d  #Which the orbital you want to focus on
DBCINTEGRANGE = -8, 2  #the energy window for intergration : Default= (emin, efermi + 2.00)
...
CMAP = gold #Default #Color map for lines. 