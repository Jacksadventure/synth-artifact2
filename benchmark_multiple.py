...
DATABASE_PATH = "result1_multiple.db"  # Path to your SQLite database
...
# Choose the subfolder containing broken files (e.g., "multiple" or "corrupted")
BROKEN_FOLDER_NAME = "multiple"
...
def populate_database():
    ...
    into the database. You can insert multiple rows per pair 
    ...
    for fmt in VALID_FORMATS:
        # e.g. generated_files/c/original, generated_files/c/multiple
        ...
        for fname in os.listdir(original_dir):
            ...
            # Construct the broken filename, e.g. multiple_1.c
